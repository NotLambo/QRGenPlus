function NavigationMenu({ hamburgerMenu = false }) {
    const styles = {
        responsive: 'flex flex-col w-full items-center gap-6 p-4 list-none sm:hidden',
    ...
    return (
            <ul className={`${hamburgerMenu ? styles.responsive : styles.default}`}>
                ...
                <a
                    className='text-2xl font-normal text-black sm:text-black decoration-none hover:border-b-4 hover:border-accent hover:cursor-pointer'
                    href="#landingpage"
                >
                    Home
                </a>
