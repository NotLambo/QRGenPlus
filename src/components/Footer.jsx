function Footer() {
  return (
    <footer className='p-4 border-black bg-accent border-t-1'>
      <div className='flex items-center justify-evenly'>
        <div className='inline-block'>
          ...
          />
          <h3 className='text-secondaryTextColor text-md'>Have questions? Make a issue!</h3>
          <a
        ...
        <ul>
          <li>
          <h3 className='text-2xl border-b text-secondaryTextColor'>Pages</h3>
          </li>
          <li className="list-none">
            <a className='text-secondaryTextColor text-md'>Home</a>
          </li>
          <li className="list-none">
            <a
              href='#faq'
              className='text-secondaryTextColor text-md'
            >
              FAQ
            </a>
          </li>
      ...
      <a
        ...
        <figure>
          <picture>
          <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width='62' height='62' fill="none" stroke="#ffffff" strokeWidth="1"
