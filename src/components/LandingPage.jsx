    ...
    <section className='p-2' id="landingpage">
      ...
      <form className='flex flex-wrap justify-center gap-6'>
        <input
          ...
          placeholder='https://qrgenplus.com'
          value={userInput}
          onChange={(e) => {
            setShowQR(false);
        ...
        className='m-15 p-4 rounded-2xl border-[0.5px] border-black w-fit h-fit text-normal bg-accent text-white text-normal font-normal hover:animate-wave'>
          Generate
          </button>
      </form>
